                ...
                if (Request.QueryString["id"] != null)
                {
                    ...
                    if (fuCompanyLogo.HasFile)
                    {
                        if (IsValidExtension(fuCompanyLogo.FileName))
                        {
                            ...
                            cmd.Parameters.AddWithValue("@ComapayImage", imagePath);
                            isValidToExecute = true;

                        }
                        else
                        {
                            lblMsg.Text = "Please select .jp, .jpeg, .png file for logo image";
                            lblMsg.CssClass = "alert alert-danger";
                        }
                    }
                    else
                    ...
                    query = "Insert into Jobs values(@Title,@NoOfPost,@Description,@Qualification, @Experience, @Specialization,@LastDateToApply,@Salary,@JobType,@CompanyName,@ComapayImage, @Website,@Email, @Address,@Country,@State,@CreateDate)";
                    type = "saved";
