        ...
        <div class="container pt-4 pb-4">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                ...
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtExperience" runat="server" CssClass="form-control" placeholder="Ex. 2years, 1.5years"
                        TextMode="Number" required></asp:TextBox>
                </div>
            </div>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                ...
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtLastDate" runat="server" CssClass="form-control" placeholder="Last Date To Apply"
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtSalary" runat="server" CssClass="form-control" placeholder="Ex. 25000/Month, 7L/Year"
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                ...
                <div class="col-md-6 pt-3">
                    <label for="ddlJobType" style="font-weight: 600">Company Logo</label>
                    <asp:FileUpload ID="fuCompanyLogo" runat="server" CssClass="form-control" ToolTip=".jpg, .jpeg, .png extension only" required />
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                ...
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtState" runat="server" CssClass="form-control" placeholder="Enter State"
                     required ></asp:TextBox>
                </div>
            </div>
            
        <div class="row mr-lg-5 ml-lg-5 mb-3 pt-4">
            <div class="col-md-3 col-mf-offset-2 mb-3">
